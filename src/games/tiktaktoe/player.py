...
class TikTakToePlayer(Player, ABC):
    ...
    def print_stats(self):
        num_wins = self.__stats[TikTakToeResult.WIN]
        print(
    ...
    def event_result(self, pos: int, result: TikTakToeResult):
